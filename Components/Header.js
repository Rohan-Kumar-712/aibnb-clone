...
function Header() {
  ...
  <header className='sticky top-0 z-50 grid grid-cols-3 bg-white shadow-md p-5 md:px-10'>
    ...
    {/* middle - search*/}
    <div className='flex items-center md:border-2 rounded-full py-2 md:shadow-lg text-slate-800'>
      <input 
      value={searchInput}
    ...
    {/* right */}
    <div className='flex items-center space-x-4 justify-end text-slate-500'>
